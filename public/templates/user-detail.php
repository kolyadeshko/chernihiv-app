            ...
            <div class="user__row">
                ...
                <div class="user__second-column">
                    ...
                    <a href="/logout" class="user__logout" v-if="userData.itsMe">
                        <div>Выйти</div><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
